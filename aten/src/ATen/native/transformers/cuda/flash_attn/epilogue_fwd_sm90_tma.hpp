...
struct CollectiveEpilogueFwd {
    ...
    store(Params const& epilogue_params,
        ...
        Tensor tOrO_out = pytorch_flash::convert_type<Element>(tOrO);
        ...
        pytorch_flash::write_O<!Seqlen_traits::kUseVarSeqLen, NumCopyThreads>(
    ...
    store_fp8(Params const& epilogue_params,
        ...
        Tensor tOrO_out = pytorch_flash::convert_type<Element>(tOrO); // Element is Ktraits::OutputType
