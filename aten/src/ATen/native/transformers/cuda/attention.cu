...
_flash_attention_forward(
  ...
  // This can be used when your sequence length q is not the full extent
  // of the tensor. This is useful for kv cache scenarios but for now
  // we will not support in this PR.
  std::optional<Tensor> seqused_q = c10::nullopt;
  ...
  std::optional<Tensor> descale_q = c10::nullopt;
  std::optional<Tensor> descale_k = c10::nullopt;
  std::optional<Tensor> descale_v = c10::nullopt;
